...
public class ScoreActivity3 extends AppCompatActivity {
    ...
    public void onClick(View view) {
        Intent intent = new Intent(ScoreActivity3.this, TestThird.class);
        startActivity(intent);
    }

    public void onClickExit(View view) {
        Intent intent = new Intent(ScoreActivity3.this, MainActivity.class);
        startActivity(intent);
    }

    public void backMain(View view) {
        Intent intent = new Intent(ScoreActivity3.this, Tests.class);
        startActivity(intent);
    }
}